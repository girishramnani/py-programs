...
class Arrow(QtGui.QGraphicsLineItem):
    def __init__(self, startItem, endItem, parent=None, scene=None,transition=0):
    ...
    def paint(self, painter, option, widget=None):
        ...
        for i in endPolygon:
            ...
            if QtCore.QLineF.BoundedIntersection == intersectType:
                break
            p1 = p2
    ...
    def mouseDoubleClickEvent(self, *args, **kwargs):
        data = QtGui.QInputDialog()
        QtCore.QArr

        data.setComboBoxItems()
        data.show()

        print("You double clicked the arrow")
...
class DiagramItem(QtGui.QGraphicsPolygonItem):
    Step, State, StartEnd, Io = range(4)
    ...
    def __init__(self, diagramType, contextMenu, parent=None, scene=None):
        ...
        if self.diagramType == self.StartEnd:
            ...
            path.fillRule()
        elif self.diagramType == self.State:
            path = QtGui.QPainterPath()
...
class DiagramScene(QtGui.QGraphicsScene):
    ...
    def mousePressEvent(self, mouseEvent):
        ...
        if self.myMode == self.InsertItem:
            ...
            self.insertText(mouseEvent)
        super(DiagramScene, self).mousePressEvent(mouseEvent)




    def insertText(self,mouseEvent,AttachedState=None):
        textItem = DiagramTextItem()
        if AttachedState!=None:
            AttachedState.StateLabel = textItem
...
class MainWindow(QtGui.QMainWindow):
    ...
    def about(self):
        QtGui.QMessageBox.about(self, "About AutoMata",
                                "The <b>Automata</b> is a simple gui application which can do smart things.")
    ...
    def createToolBox(self):
        ...
        layout.addWidget(self.createCellWidget("State", DiagramItem.State),
                         0, 0)
        layout.addWidget(self.createCellWidget("Final State", DiagramItem.Step), 0,
                         1)
        ...
        self.toolBox.addItem(itemWidget, "Basic automata pieces")
    ...
    def createToolbars(self):
        ...
        self.sceneScaleCombo.addItems(["25%","30%","40%","50%", "75%", "100%", "125%", "150%"])
