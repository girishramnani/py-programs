...
#
# Created: Thu Jan 29 12:57:11 2015
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Pydownloader", None))
        self.label.setText(_translate("Dialog", "URL", None))
        self.label_2.setText(_translate("Dialog", "Save File as", None))
        self.pushButton_2.setText(_translate("Dialog", "Download", None))
